...
Dari tabel \ref{tabel:uat_admin_cabang_hasil} di atas, kita dapat menghitung skor \textit{User Acceptance Test} (UAT) untuk perspektif Admin Cabang dengan menggunakan rumus \ref{eq:uat} sebagai berikut:
