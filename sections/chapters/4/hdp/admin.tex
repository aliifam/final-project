...
Setelah memilih cabang, admin akan diarahkan ke halaman dasbor admin cabang. Pada halaman ini, admin dapat melihat informasi garis besar mengenai cabang yang dikelola seperti pada Gambar \ref{fig:halaman-dasbor-admin}, Potongan implementasi kode untuk mendapatkan data yang ditampilkan pada dasbor cabang yang dikelola oleh admin saat setelah login dapat dilihat pada kode \ref{lst:be-pilih-admin-dasbor}.
...
Saat proses pembersihan dimulai maka Admin akan mendapatkan kunci pod yang sedang dibersihkan, sehingga admin dapat mengakses pod tersebut untuk melakukan pembersihan, kunci tersebut hanya berlaku selama tiga jam dan bila lebih dari itu maka kunci harus diperbarui kembali, berikut potongan implementasi kode untuk mendapatkan kunci pod yang sedang dibersihkan oleh admin pada kode \ref{lst:be-generate-kunci-pod-admin}.
...
Setelah Admin memasukkan harga dinamis maka harga tersebut akan digunakan untuk menentukan harga reservasi tergantung pada tanggal reservasi dan jenis pod yang dipilih oleh tamu, berikut potongan implementasi kode untuk mendapatkan harga dinamis berdasarkan tanggal pada kode \ref{lst:be-harga-dinamis-admin}.
