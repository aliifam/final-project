...
Pada kode \ref{lst:simple-react-button} berikut adalah contoh komponen tombol sederhana yang dibuat dengan React TSX. Komponen ini dapat digunakan untuk berbagai keperluan dalam aplikasi web, seperti tombol untuk mengirim formulir atau tombol navigasi.

\lstinputlisting[
    language=TSX,
    caption={Komponen tombol sederhana dalam React TSX},
    label={lst:simple-react-button}
]{codes/cd.tsx}