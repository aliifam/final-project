...
Pada kode \ref{lst:fe-reservasi-user-search}, implementasi frontend untuk halaman pencarian Pod yang tersedia ditampilkan. pada halaman ini \textit{Frontend} akan menampilkan detail cabang, tanggal, dan daftar Pod yang tersedia untuk di reservasi dengan berinteraksi via API yang telah dibuat pada kode backend sebelumnya. Pengguna dapat memilih Pod yang diinginkan dan melanjutkan ke proses reservasi seperti pada gambar \ref{fig:hasil-pencarian-user}.
...
Setelah pengguna memasukkan tanggal dan cabang yang diinginkan, sistem akan menampilkan daftar Pod yang tersedia untuk reservasi pada tanggal tersebut. Pengguna dapat memilih Pod yang diinginkan dan melanjutkan ke proses reservasi. Tampilan hasil pencarian dapat dilihat pada gambar \ref{fig:hasil-pencarian-user}..
