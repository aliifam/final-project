...
\subsection{Draw.io (VSCode Extension)}
...
\begin{longtable}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.2\textwidth}|m{0.5\textwidth}|}
    ...
    \includegraphics[width=0.1\textwidth]{images/ad/initial-node.png} & \textit{Initial Node} & Menandakan titik awal dari proses atau alur aktivitas. \\ \hline

    \includegraphics[width=0.1\textwidth]{images/ad/final-node.png} & \textit{Final Node} & Menandakan akhir dari proses atau alur aktivitas. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/ad/activity.png} & \textit{Activity} & Menggambarkan aktivitas tertentu dalam proses atau alur kerja. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/ad/condition.png} & \textit{Condition} & Menunjukkan keputusan atau kondisi yang menentukan percabangan alur aktivitas. \\ \hline
...
\begin{longtable}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.2\textwidth}|m{0.5\textwidth}|}
    ...
    \includegraphics[width=0.2\textwidth]{images/erd/association.png} & \textit{Association} & Menggambarkan hubungan antara dua entitas dalam model data. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/erd/entity.png} & \textit{Entity} & Merepresentasikan objek atau konsep yang memiliki data yang disimpan dalam sistem. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/erd/attribute.png} & \textit{Attribute} & Menunjukkan informasi atau properti yang dimiliki oleh sebuah entitas atau hubungan. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/erd/relation.png} & \textit{Relation} & Menjelaskan hubungan antara dua atau lebih entitas, termasuk kardinalitasnya. \\ \hline
