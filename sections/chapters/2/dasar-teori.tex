...
\begin{longtable}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.5\textwidth}|}
    \hline
    ...
    \includegraphics[width=0.1\textwidth]{images/ucd/orang.png} & Actor & Representasi pengguna atau sistem eksternal yang berinteraksi dengan sistem. \\ \hline
    \includegraphics[width=0.1\textwidth]{images/ucd/orang.png} & Actor & Representasi pengguna atau sistem eksternal yang berinteraksi dengan sistem. \\ \hline
    \includegraphics[width=0.1\textwidth]{images/ucd/orang.png} & Actor & Representasi pengguna atau sistem eksternal yang berinteraksi dengan sistem. \\ \hline
    \includegraphics[width=0.1\textwidth]{images/ucd/orang.png} & Actor & Representasi pengguna atau sistem eksternal yang berinteraksi dengan sistem. \\ \hline
    \includegraphics[width=0.1\textwidth]{images/ucd/orang.png} & Actor & Representasi pengguna atau sistem eksternal yang berinteraksi dengan sistem. \\ \hline
