...
\begin{longtable}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.2\textwidth}|m{0.5\textwidth}|}
    ...
    \includegraphics[width=0.2\textwidth]{images/dd/node.png}     & \textit{Node}     & Komponen perangkat lunak atau infrastruktur tempat proses aplikasi berjalan \textit{(server, platform, service)}. \\ \hline

    \includegraphics[width=0.2\textwidth]{images/dd/package.png}  & \textit{Package}  & Digunakan untuk mengelompokkan node/layanan secara logis.                                                         \\ \hline

    \includegraphics[width=0.2\textwidth]{images/dd/cloud.png}    & \textit{Cloud}    & Representasi layanan berbasis cloud seperti Google Cloud Platform, Internet, dll.                                 \\ \hline

    \includegraphics[width=0.2\textwidth]{images/dd/artifact.png} & \textit{Artifact} & Unit perangkat lunak atau file yang ter-deploy, misalnya \textit{frontend} atau \textit{backend}.                 \\ \hline

    \includegraphics[width=0.2\textwidth]{images/dd/artifact.png} & \textit{Artifact} & Unit perangkat lunak atau file yang ter-deploy, misalnya \textit{frontend} atau \textit{backend}.                 \\ \hline

    \includegraphics[width=0.2\textwidth]{images/dd/artifact.png} & \textit{Artifact} & Unit perangkat lunak atau file yang ter-deploy, misalnya \textit{frontend} atau \textit{backend}.                 \\ \hline

    \caption{Notasi \textit{Deployment Diagram}}
\end{longtable}

\subsection{\textit{Sequence Diagram}}

Sequence Diagram digunakan untuk menggambarkan interaksi antar objek dalam suatu sistem berdasarkan urutan waktu. Diagram ini menampilkan objek-objek yang terlibat, pesan yang dikirim antar objek, dan urutan eksekusi pesan tersebut. Sequence Diagram membantu dalam memahami bagaimana objek berinteraksi satu sama lain untuk menyelesaikan suatu fungsi atau skenario tertentu.
