...
Pada gambar \ref{fig:ucd_sa}, ditampilkan use case diagram untuk SuperAdmin (Admin Pusat). SuperAdmin memiliki akses penuh untuk mengelola seluruh sistem, termasuk pengelolaan Admin Cabang, pengaturan data - data master, dasbor global, serta verisikasi dan sistem persetujuan.
...
Pada gambar \ref{fig:ucd_admin2}, ditampilkan use case diagram yang merupakan untuk use case diagram Admin Cabang juga yang dibagi menjadi dua yaitu pada gambar \ref{fig:ucd_admin1} dan gmabar \ref{fig:ucd_admin2} karena jika digabung akan terllau besar dan tidak terbaca diagramnya, diagram ini mencakup manajemen operasional harian, input data via \textit{Online Travel Agent (OTA)}, dan sistem manajemen \textit{Review} dan \textit{Rating}.
